...
<div>
<p style="font-size:30px; text-align:center;">문의하기</p>
</div>
<div style="text-align:center;">
	...
	<div style="text-align:center;">
	<input type="checkbox" id=noticeCheckbox name=noticeCheckbox> 비밀글 <input type=button value=글쓰기>&nbsp;&nbsp;<input type=button value=취소>
	</div>
</div>
