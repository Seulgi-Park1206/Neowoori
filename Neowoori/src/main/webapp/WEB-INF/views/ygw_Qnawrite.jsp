...
<form action="/Qnaserver" method="post">
	...
	<input type=submit id=qnawrite class="btn btn-outline-secondary" value=글쓰기>&nbsp;&nbsp;<input type=button class="btn btn-outline-secondary" value=취소 onclick=listqna()>
	</div>
</form>
</div>
