...
public class BJsbStudyInfo {
	...
	public BJsbStudyInfo(String uNick, int mNum, int uNum, String mName, String category1, String category2,
			String mWhere, String mDay, String mContents, String mPersonnel, String mTime, String mPtime, String mLevel,
			String lati, String longi, String mWhere2, String mWhere3) {
//		super();
		this.uNick = uNick;
		this.mNum = mNum;
		this.uNum = uNum;
